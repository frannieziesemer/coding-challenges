...
## challenges 
what is the node? - the row? or the index of the row? 
How did i overcome this:
  - reading through the explanation and checking the examples 
  - i found that the node is row or column 
  - the combination of the nodes is the intersection in the matrix 
